...
export async function main(args: string[]) {
  ...
  program
    .name('dataprism')
    .description('DataPrism Core CLI - Build high-performance browser analytics applications')
  ...
  program.on('--help', () => {
    ...
    console.log('');
    console.log(chalk.gray('For more information, visit: https://docs.dataprism.dev'));
  });
