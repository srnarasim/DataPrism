...
export default defineConfig({
  ...
  description: 'High-performance browser-based analytics engine with WebAssembly',
  ...
  head: [
    ...
    ['meta', { property: 'og:image', content: 'https://docs.dataprism.dev/og-image.png' }],
    ...
    nav: [
      ...
      { text: 'Plugins', link: '/plugins/' },
      {
        ...
        items: [
          ...
          { text: 'NPM', link: 'https://www.npmjs.com/package/@dataprism/core' }
        ]
      }
    ],
      ...
      '/plugins/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Performance Monitor', link: '/plugins/performance-monitor' }
          ]
        },
        {
          text: 'Plugin API',
  ...
  vite: {
    resolve: {
      alias: {
        ...
        '@dataprism/plugin-framework': resolve(__dirname, '../../../packages/plugins/src')
      }
    },
    optimizeDeps: {
      exclude: [
